...
export default declareComponent(RwLocalStoriesSimple, {
  ...
  description:
    "Plain stand-in for the local stories carousel: heading, short paragraph and one button through to the stories. No CMS binding needed. Keeps the #stories anchor so the report's jump cards still work. Links to rewiring.nz/story by default.",
  ...
  props: {
    ...
    buttonLabel: props.Text({ name: "Button label", defaultValue: "Explore case studies", group: "Content" }),
    storiesUrl: props.Link({ name: "Button URL (blank = rewiring.nz/story)", group: "Content" }),
