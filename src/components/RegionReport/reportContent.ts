// AUTO-GENERATED v2 report markup + scoped CSS. Tokens {{x}} are filled from District.fields.
export const CSS = `.rw-region-report{
      ...
      }.rw-region-report *{ box-sizing: border-box; margin: 0; padding: 0; }.rw-region-report{ scroll-behavior: smooth; scroll-padding-top: 80px; }.rw-region-report{ background: var(--cream); color: var(--ink); font-family: 'Rubik', system-ui, sans-serif; -webkit-font-smoothing: antialiased; line-height: 1.6; }.rw-region-report .report-banner{ display: block; background: var(--gold); color: var(--ink); text-align: center; font-size: 14.5px; font-weight: 600; padding: 10px 24px; text-decoration: none; }.rw-region-report .report-banner:hover{ background: #ffc94d; }.rw-region-report .report-banner strong{ font-weight: 700; }.rw-region-report .hero{ background: linear-gradient(160deg, #2c5e5b 0%, #14302f 100%); color: var(--on-dark); padding: 88px 32px; position: relative; }.rw-region-report .hero-inner{ max-width: 1040px; margin: 0 auto; display: grid; grid-template-columns: minmax(220px, 330px) 1fr; gap: 64px; align-items: center; }.rw-region-report .hero-cover{ width: 100%; }.rw-region-report .hero-cover img{ width: 100%; height: auto; display: block; transform: rotate(-3deg); }.rw-region-report .hero-text{ text-align: left; }.rw-region-report .hero h1{ font-size: clamp(40px, 5vw, 66px); font-weight: 700; color: var(--cream); margin: 0 0 18px; line-height: 1.04; letter-spacing: -0.01em; }.rw-region-report .hero p{ font-size: 1.18rem; font-weight: 400; max-width: 780px; margin: 0; line-height: 1.5; opacity: 0.9; }
      ...
      }.rw-region-report .squiggle-under{ position: relative; display: inline-block; padding-bottom: 10px; }.rw-region-report .squiggle-under::after{
      ...
      }.rw-region-report .container{ max-width: 1080px; margin: 0 auto; padding: 0 24px; }.rw-region-report .container-narrow{ max-width: 720px; margin: 0 auto; padding: 0 24px; }.rw-region-report .stat-card{
        background: #ffffff;
        padding: 32px;
        border-radius: var(--squiggle);
        border: 2px dashed var(--gold);
      }.rw-region-report .stat-card .big{ font-size: 40px; font-weight: 700; color: var(--ink); line-height: 1.05; margin-bottom: 8px; letter-spacing: -0.01em; }.rw-region-report .stat-card .label{ font-weight: 600; font-size: 20px; margin-bottom: 4px; color: var(--mid); }.rw-region-report .stat-card .sub{ font-size: 14px; color: var(--muted); }.rw-region-report .section{ padding: 96px 0; }.rw-region-report .theme-dark{ background: linear-gradient(160deg, #245755 0%, #122c2c 100%); color: var(--on-dark); position: relative; }.rw-region-report .theme-dark h2, .rw-region-report .theme-dark h3, .rw-region-report .theme-dark .big{ color: var(--cream); }.rw-region-report .theme-dark .section-head h2{ color: var(--cream); }.rw-region-report .theme-dark .section-head p{ color: var(--on-dark); }.rw-region-report .theme-dark .prose, .rw-region-report .theme-dark .prose p{ color: var(--on-dark); }.rw-region-report .theme-dark .prose strong{ color: var(--cream); }.rw-region-report .theme-dark .label, .rw-region-report .theme-dark .meta{ color: var(--on-dark); }.rw-region-report .theme-dark .savings{ color: var(--gold); }.rw-region-report .theme-dark .stat-card{ background: rgba(255,255,255,0.08); border-color: var(--on-dark); }.rw-region-report .theme-dark .stat-card .big{ color: var(--cream); }.rw-region-report .theme-dark .stat-card .label{ color: var(--on-dark); }.rw-region-report .theme-dark .section-tag{ color: var(--gold); }.rw-region-report .theme-yellow{ background: var(--gold); color: var(--ink); }.rw-region-report .theme-yellow .section-head h2{ color: var(--ink); }.rw-region-report .theme-yellow .section-head p{ color: var(--ink); opacity: 0.8; }.rw-region-report .theme-yellow .section-tag{ color: var(--ink); opacity: 0.7; }.rw-region-report .theme-yellow .stat-card{ background: #fff; border-color: var(--ink); }.rw-region-report .theme-yellow .impact-card{ background: #fff; border-color: var(--ink); }.rw-region-report .theme-yellow .savings{ color: var(--ink); }.rw-region-report .theme-yellow .squiggle-under::after{
      ...
      @media (max-width: 780px) {.rw-region-report .section-illo{ width: 132px; } }.rw-region-report .jumpnav{ display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; max-width: 920px; margin: 4px auto 60px; }.rw-region-report .jump-card{ display: flex; flex-direction: column; align-items: center; gap: 10px; text-decoration: none; background: #ffffff; border: 2px solid var(--grid); border-radius: 18px; padding: 18px 10px; cursor: pointer; transition: transform .18s ease, box-shadow .18s ease, border-color .18s ease, background-color .18s ease; }.rw-region-report .jump-card:hover, .rw-region-report .jump-card.is-active{ transform: translateY(-3px); box-shadow: 0 10px 22px rgba(0,0,0,0.10); border-color: var(--gold); }.rw-region-report .jump-card.is-active{ background: #fbf3d6; }.rw-region-report .jump-card:focus-visible{ outline: 2px solid var(--gold); outline-offset: 2px; }.rw-region-report .jump-card img{ width: 64px; height: 64px; object-fit: contain; }.rw-region-report .jump-card span{ font-size: 13px; font-weight: 600; color: var(--ink); text-align: center; line-height: 1.25; }
      @media (max-width: 720px) {.rw-region-report .jumpnav{ grid-template-columns: repeat(2, 1fr); gap: 12px; } }.rw-region-report .reveal{ opacity: 0; transform: translateY(22px); transition: opacity .6s ease-out, transform .6s ease-out; }.rw-region-report .reveal.in{ opacity: 1; transform: none; }.rw-region-report .two-col{ display: grid; grid-template-columns: 1fr 1fr; gap: 56px; align-items: stretch; }.rw-region-report .two-col > .savings-box{ align-self: center; }
      @media (max-width: 768px) {.rw-region-report .two-col{ grid-template-columns: 1fr; gap: 32px; } }.rw-region-report .prose{ font-size: 16px; line-height: 1.65; color: var(--mid); }.rw-region-report .prose p{ margin-bottom: 16px; }.rw-region-report .prose p:last-child{ margin-bottom: 0; }.rw-region-report .prose strong{ color: var(--ink); font-weight: 600; }.rw-region-report .savings{ font-size: 56px; font-weight: 700; color: var(--ink); line-height: 1; margin: 12px 0 8px; letter-spacing: -0.02em; }.rw-region-report .meta{ font-size: 14px; color: var(--muted); margin-bottom: 12px; line-height: 1.4; }.rw-region-report .meta span{ display: inline-flex; align-items: center; margin-right: 16px; }.rw-region-report .savings-box{ display: flex; flex-wrap: wrap; gap: 20px; max-width: 100%; align-items: stretch; }.rw-region-report .savings-stat{
        flex: 1 1 200px;
        background: #ffffff;
        border: 2px dashed var(--gold);
        border-radius: var(--squiggle);
      ...
      @media (max-width: 780px) {.rw-region-report .savings-stat{ padding: 22px 24px; }.rw-region-report .savings-stat .stat-num{ font-size: clamp(30px, 9vw, 40px); } }.rw-region-report .bills-intro{ display: grid; grid-template-columns: 264px 1fr; gap: 32px; align-items: center; max-width: 960px; margin: 0 auto 40px; }.rw-region-report .bills-intro-stats{ display: flex; flex-direction: column; gap: 16px; }.rw-region-report .bills-intro .prose p{ margin: 0 0 14px; }.rw-region-report .bills-intro .prose p:last-child{ margin-bottom: 0; }
      @media (max-width: 768px) {.rw-region-report .bills-intro{ grid-template-columns: 1fr; gap: 20px; }.rw-region-report .bills-intro-stats{ flex-direction: row; }.rw-region-report .bills-intro-stats .savings-stat{ flex: 1 1 0; }
      }
      @media (max-width: 460px) {.rw-region-report .bills-intro-stats{ flex-direction: column; } }.rw-region-report .chart-wrap{
        background: #ffffff;
        border-radius: 16px;
        padding: 32px;
        border: 1px solid var(--grid);
      }.rw-region-report .chart-scroll{ width: 100%; overflow-x: auto; overflow-y: hidden; -webkit-overflow-scrolling: touch; touch-action: auto; }.rw-region-report .chart-inner{ min-width: 500px; height: 480px; }.rw-region-report .chart-title{ font-size: 22px; font-weight: 700; margin-bottom: 4px; color: var(--ink); letter-spacing: -0.01em; }.rw-region-report .chart-sub{ font-size: 13px; color: var(--muted); margin-bottom: 16px; }.rw-region-report .legend{ display: flex; flex-wrap: wrap; gap: 10px 20px; margin: 0 0 20px; font-size: 13px; color: var(--ink); }.rw-region-report .legend-item{ display: flex; align-items: center; gap: 8px; cursor: pointer; user-select: none; padding: 4px 0; }.rw-region-report .legend-item[data-dim="true"]{ opacity: 0.35; }.rw-region-report .swatch{ width: 12px; height: 12px; border-radius: 3px; flex-shrink: 0; }.rw-region-report .recharts-cartesian-axis-tick-value{ font-family: 'Rubik', sans-serif; font-size: 12px; }.rw-region-report .impact-card{
        background: #ffffff;
        border-radius: var(--squiggle);
        border: 2px dashed var(--gold);
        padding: 32px;
        text-align: center;
      }.rw-region-report .impact-card .big{ font-size: 40px; font-weight: 700; color: var(--ink); line-height: 1.05; margin-bottom: 8px; letter-spacing: -0.01em; }.rw-region-report .impact-card .label{ font-weight: 600; color: var(--mid); font-size: 20px; }.rw-region-report .btn{
      ...
      }.rw-region-report .btn:hover{ transform: translateY(-2px); box-shadow: 0 8px 18px rgba(0,0,0,0.12); }.rw-region-report .btn-yellow{ background: var(--gold); border-color: var(--gold); color: var(--ink); }.rw-region-report .footer{ background: linear-gradient(160deg, #1f4d4b 0%, #122c2c 100%); color: var(--on-dark); padding: 48px 32px; text-align: center; font-size: 14px; position: relative; }.rw-region-report .hero::after, .rw-region-report .theme-dark::after, .rw-region-report .theme-green::after, .rw-region-report .footer::after{
        content: ""; position: absolute; inset: 0; pointer-events: none;
        background-image: var(--noise); background-size: 180px 180px;
        opacity: 0.20; z-index: 0;
      }.rw-region-report .hero > *, .rw-region-report .theme-dark > *, .rw-region-report .theme-green > *, .rw-region-report .footer > *{ position: relative; z-index: 1; }.rw-region-report .footer a{ color: var(--cream); font-weight: 600; text-decoration: underline; }.rw-region-report .footer a:hover{ color: var(--gold); }.rw-region-report .tabs-title{ font-size: 22px; font-weight: 700; margin-bottom: 20px; color: var(--ink); letter-spacing: -0.01em; }.rw-region-report .tabs-header{ display: flex; gap: 4px; margin-bottom: 0; border-bottom: 1px solid var(--grid); }.rw-region-report .tab-btn{
        ...
        min-height: 44px;
      }.rw-region-report .tab-btn:hover{ color: var(--ink); }.rw-region-report .tab-btn.active{ color: var(--ink); border-bottom-color: var(--gold); }.rw-region-report .tab-btn:focus-visible{ outline: 2px solid var(--gold); outline-offset: 2px; border-radius: 4px; }.rw-region-report .tabs-header + .chart-wrap{ border-top-left-radius: 0; }.rw-region-report .tab-panel{ display: none; }.rw-region-report .tab-panel.active{ display: block; }.rw-region-report .tabs-card{
        background: #ffffff;
      ...
      @media (max-width: 780px) {.rw-region-report .tabs-card, .rw-region-report .tabs-header + .chart-wrap{ border-top-left-radius: 0; border-top-right-radius: 0; } }.rw-region-report .horiz-chart-inner{ min-width: 400px; }.rw-region-report .legend-item:focus-visible{ outline: 2px solid var(--gold); outline-offset: 2px; border-radius: 4px; }.rw-region-report .story-card{
        display: grid;
      ...
      }.rw-region-report .story-body{ padding: 8px 8px 8px 0; }.rw-region-report .story-card.no-photo{ grid-template-columns: 1fr; }.rw-region-report .story-card.no-photo .story-photo{ display: none; }.rw-region-report .story-card.no-photo .story-body{
        padding: 8px; display: flex; flex-direction: column;
        align-items: center; justify-content: center; text-align: center;
      }.rw-region-report .story-card.no-photo .story-tags{ justify-content: center; }.rw-region-report .story-title{
      ...
      }.rw-region-report .download-card{
        text-align: center;
        background: #ffffff;
        border: 2px dashed var(--gold);
        border-radius: var(--squiggle);
      ...
      @media (max-width: 780px) {.rw-region-report .tab-btn{ padding: 12px 16px; font-size: 13px; }.rw-region-report .hero{ padding: 64px 20px 56px; }.rw-region-report .stat-card{ padding: 24px; }.rw-region-report .stat-card .big{ font-size: 32px; }.rw-region-report .impact-card{ padding: 24px; }.rw-region-report .impact-card .big{ font-size: 32px; }.rw-region-report .savings{ font-size: 44px; }.rw-region-report .section{ padding: 56px 0; }.rw-region-report .chart-inner{ height: 400px; min-width: 560px; }.rw-region-report .chart-wrap{ padding: 20px; }.rw-region-report .tabs-card{ padding: 20px; }
      }
    ...
    .cumulative-copy{ max-width: 720px; margin: 14px auto 0; text-align: center; font-size: 17px; line-height: 1.55; color: var(--mid); }.rw-region-report .bills-lead{ max-width: 780px; margin: 0 auto 28px; text-align: center; }.rw-region-report .fine{ display: block; margin-top: 6px; font-size: 13px; line-height: 1.4; color: var(--mid); }.rw-region-report .sources{ max-width: 780px; margin: 36px auto 0; font-size: 13px; color: var(--mid); line-height: 1.5; }.rw-region-report .sources-title{ font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; font-size: 12px; margin-bottom: 6px; }.rw-region-report .sources ol{ margin: 0; padding-left: 20px; }.rw-region-report .sources a{ color: inherit; text-decoration: underline; text-underline-offset: 2px; }.rw-region-report .sources a:hover{ color: var(--ink); }.rw-region-report .report-version{ margin-top: 14px; font-size: 12px; color: var(--muted); }.rw-region-report .prose sup{ font-size: 0.7em; line-height: 0; }.rw-region-report .hl-calc-link{ text-align: center; font-size: 15px; font-weight: 700; margin: 0 0 40px; }.rw-region-report .hl-calc-link a{ color: var(--ink); text-decoration: underline; text-underline-offset: 3px; }.rw-region-report .hl-calc-link a:hover{ color: #27ae60; }
      ...
      @media (max-width: 460px) {.rw-region-report .headline-stats{ grid-template-columns: 1fr; } }.rw-region-report .hero-inner--solo{ grid-template-columns: 1fr; justify-items: center; }.rw-region-report .hero-inner--solo .hero-text{ text-align: center; }.rw-region-report .hero-pdf-btn{ display: inline-flex; align-items: center; gap: 8px; margin-top: 24px; background: var(--gold); color: var(--ink); font-weight: 700; font-size: 15px; text-decoration: none; padding: 12px 24px; border-radius: 100px; transition: background-color .18s ease, transform .18s ease; }.rw-region-report .hero-pdf-btn:hover{ background: #ffc94d; transform: translateY(-2px); }.rw-region-report .hero-pdf-btn svg{ width: 18px; height: 18px; }
      @media print {.rw-region-report .hero-pdf-btn{ display: none !important; } }.rw-region-report .hero-sub{ font-size: 1.15rem; opacity: 0.9; margin-top: 14px; max-width: 780px; line-height: 1.5; margin-left: auto; margin-right: auto; }.rw-region-report .jump-group-title{ text-align: center; font-size: 14px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; color: var(--mid); margin: 30px 0 14px; }.rw-region-report .jumpnav--benefit, .rw-region-report .jumpnav--machine{ grid-template-columns: repeat(5, 1fr); max-width: 1000px; margin: 0 auto; }.rw-region-report .section--overview{ padding-bottom: 36px; }
      @media (max-width: 860px) {.rw-region-report .jumpnav--benefit, .rw-region-report .jumpnav--machine{ grid-template-columns: repeat(3, 1fr); } }
      @media (max-width: 540px) {.rw-region-report .jumpnav--benefit, .rw-region-report .jumpnav--machine{ grid-template-columns: repeat(2, 1fr); } }.rw-region-report .guide-btn-row{ display: flex; justify-content: center; gap: 14px; flex-wrap: wrap; margin-top: 30px; }.rw-region-report .theme-yellow .guide-btn{ background: var(--ink); color: var(--cream); }.rw-region-report .theme-yellow .guide-btn:hover{ background: #2c5e5b; }.rw-region-report .guide-btn{ display: inline-flex; align-items: center; gap: 8px; background: var(--gold); color: var(--ink); font-weight: 700; font-size: 15px; text-decoration: none; padding: 13px 26px; border-radius: 100px; transition: background-color .18s ease, transform .18s ease; }.rw-region-report .guide-btn:hover{ background: #ffc94d; transform: translateY(-2px); }.rw-region-report .savings-box{ flex-direction: column; }.rw-region-report .stories-carousel{ position: relative; max-width: 980px; margin: 0 auto; }.rw-region-report .stories-track{ display: flex; overflow-x: auto; scroll-snap-type: x mandatory; gap: 24px; padding: 4px; scrollbar-width: none; }.rw-region-report .stories-track::-webkit-scrollbar{ display: none; }.rw-region-report .stories-track > .story-card{ flex: 0 0 100%; scroll-snap-align: center; }.rw-region-report .carousel-arrow{ position: absolute; top: 50%; transform: translateY(-50%); z-index: 5; width: 44px; height: 44px; border-radius: 50%; border: none; background: var(--gold); color: var(--ink); font-size: 26px; line-height: 1; font-weight: 700; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 14px rgba(0,0,0,0.18); transition: background-color .18s ease; }.rw-region-report .carousel-arrow:hover{ background: #ffc94d; }.rw-region-report .carousel-prev{ left: -20px; }.rw-region-report .carousel-next{ right: -20px; }.rw-region-report .carousel-dots{ display: flex; gap: 8px; justify-content: center; margin-top: 18px; }.rw-region-report .carousel-dots button{ width: 10px; height: 10px; border-radius: 50%; border: none; background: rgba(255,255,255,0.4); cursor: pointer; padding: 0; }.rw-region-report .carousel-dots button.active{ background: var(--gold); }
      @media (max-width: 780px) {.rw-region-report .carousel-prev{ left: 4px; }.rw-region-report .carousel-next{ right: 4px; } }.rw-region-report .community-card{ max-width: 920px; margin: 0 auto; background: #fff; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.14); color: var(--ink); }.rw-region-report .community-banner{ height: 240px; background: #e9e3cf; }.rw-region-report .community-banner img{ width: 100%; height: 100%; object-fit: cover; display: block; }.rw-region-report .community-banner-ph{ height: 100%; display: flex; flex-direction: column; gap: 10px; align-items: center; justify-content: center; color: #8a836b; font-size: 14px; text-align: center; padding: 0 20px; }.rw-region-report .community-body{ padding: 30px 34px 36px; }.rw-region-report .community-name{ font-size: 26px; font-weight: 700; margin: 0 0 8px; color: var(--ink); }.rw-region-report .community-sub{ font-size: 15px; color: #4a6664; line-height: 1.55; margin: 0 0 22px; max-width: 680px; }.rw-region-report .cumulative-block{ text-align: center; margin: 0 auto 44px; max-width: 900px; }.rw-region-report .cumulative-title{ font-size: clamp(21px, 2.5vw, 30px); font-weight: 700; line-height: 1.25; margin-bottom: 22px; color: var(--ink); }.rw-region-report .cumulative-ph{ min-height: 240px; border: 2px dashed var(--mid); border-radius: 16px; display: flex; align-items: center; justify-content: center; color: var(--muted); font-size: 15px; background: rgba(0,0,0,0.02); padding: 20px; }.rw-region-report #cumulative-chart:not(.cumulative-ph){ background: #ffffff; border: 1px solid var(--grid); border-radius: 16px; padding: 32px 24px 20px; }.rw-region-report .group-picker{ display: flex; align-items: center; gap: 10px; margin: 4px 0 14px; font-family: Rubik, sans-serif; }.rw-region-report .group-picker label{ font-size: 13px; font-weight: 600; color: #1a3c3c; }.rw-region-report .group-picker select{ font-family: Rubik, sans-serif; font-size: 14px; font-weight: 600; color: #1a3c3c;
        padding: 6px 12px; border: 2px solid #1a3c3c; border-radius: 8px; background: #fff; cursor: pointer; }
    
.rw-region-report .section-head[id]{scroll-margin-top:90px;}`;

export const TEMPLATE = `<a class="report-banner" href="https://pages.rewiring.nz/electric-homes-and-vehicles" target="_blank" rel="noopener noreferrer">
      <span>Dig into the numbers behind these figures in the <strong>Electric Homes &amp; Vehicles Report 2026</strong> &mdash; read the full national report &rarr;</span>
    </a>
    ...
    <div class="hero">
      <div class="hero-inner hero-inner--solo">
        <div class="hero-text">
          ...
          <a class="hero-pdf-btn" href="https://regional-reports.pages.dev/pdf/electrifying-{{slug}}.pdf" target="_blank" rel="noopener noreferrer"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>Download the report (PDF)</a>
        </div>
      </div>
    </div>

    <!-- Overview: intro + headline stats + jump links -->
    <div class="section section--overview">
      <div class="container">
        <div class="prose" style="max-width:780px; margin: 0 auto 32px; text-align:center;">
          <p>{{location}} has <strong>crossed the electrification tipping point</strong> where homes can save money and reduce their emissions by going electric.</p>
          <p>The technology is proven, the economics stack up, and the transition is already underway. But there are still plenty of households paying more than they need to by running on fossil fuels.</p>
        </div>
      ...
      <div class="container">
        ...
        <div class="two-col">
          <div class="impact-card" style="text-align:center;">
            <div class="big">{{co2e_annual}} tonnes CO₂e</div>
            <div class="label">avoided every year</div>
            <div class="prose" style="margin-top:12px; text-align:center;">
              <p>Electrifying {{location}}'s homes will result in a significant reduction in emissions. That's the equivalent of <strong>{{equiv_flights}} one-way flights</strong> per passenger from Auckland to Queenstown.</p>
            </div>
          </div>
          <div class="impact-card" style="text-align:center;">
        ...
        <div class="two-col" style="margin-bottom:32px;">
          <div class="savings-box">
            <div class="savings-stat">
              <div class="stat-num num-save">{{solar_box1_num}} <span class="stat-word">savings</span></div>
    ...
    <div class="section theme-green">
      <div class="container">
        ...
        <div class="two-col" style="margin-bottom:32px;">
          <div class="savings-box">
            <div class="savings-stat">
              ...
              <div class="meta">net over 15 years from a petrol to electric medium SUV</div>
            </div>
            <div class="savings-stat">
        ...
        <div id="ev-tabs"></div>
        <div class="guide-btn-row"><a class="guide-btn" href="https://www.rewiring.nz/this-car-can-info" target="_blank" rel="noopener noreferrer">Explore EV guide</a></div>
      </div>
    </div>
    ...
    <div class="section">
      <div class="container">
        ...
        <div class="guide-btn-row"><a class="guide-btn" href="https://www.rewiring.nz/electrification-guides/space-heating-and-cooling" target="_blank" rel="noopener noreferrer">Explore heat pump guide</a></div>
      </div>
    </div>
    ...
    <div class="section theme-green">
      <div class="container">
        ...
        <div class="guide-btn-row"><a class="guide-btn" href="https://www.rewiring.nz/electrification-guides/water-heating" target="_blank" rel="noopener noreferrer">Explore hot water heat pump guide</a></div>
      </div>
    </div>
    ...
    <div class="section">
      <div class="container">
        ...
        <div class="sources">
          ...
          <ol>
            <li><a href="https://www.consumer.org.nz/articles/new-zealand-electric-car-myths-debunked" target="_blank" rel="noopener noreferrer">Consumer NZ, <em>New Zealand electric car myths debunked</em>, 2025</a></li>
            <li><a href="https://www.powerswitch.org.nz/the-best-power-plans-for-charging-your-ev" target="_blank" rel="noopener noreferrer">Powerswitch, <em>The best power plans for charging your EV</em></a></li>
            <li><a href="https://www.transport.govt.nz/assets/Uploads/EV-Charging-Strategy.pdf" target="_blank" rel="noopener noreferrer">Ministry of Transport, <em>Charging Our Future: National electric vehicle charging strategy for Aotearoa New Zealand 2023–2035</em>, 2023</a></li>
            <li><a href="https://environment.govt.nz/publications/our-air-2024/" target="_blank" rel="noopener noreferrer">Ministry for the Environment, <em>Our Air 2024</em>, 2024</a></li>
            <li><a href="https://www.eeca.govt.nz/insights/eeca-insights/indoor-combustion-in-new-zealand-homes-health-effects-and-costs/" target="_blank" rel="noopener noreferrer">EECA, <em>Indoor combustion in New Zealand homes: health effects and costs</em>, 2025</a></li>
          </ol>
          <div class="report-version">Report v1.0</div>
        </div>
      </div>
    </div>
