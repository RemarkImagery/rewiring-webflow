...
export const CSS = `.rw-region-report{
      ...
      @media (max-width: 460px) {.rw-region-report .bills-intro-stats{ flex-direction: column; } }.rw-region-report .chart-wrap{
        ...
        border-top: none;
        padding: 32px;
      }.rw-region-report .horiz-chart-inner{ min-width: 400px; }.rw-region-report .legend-item:focus-visible{ outline: 2px solid var(--gold); outline-offset: 2px; border-radius: 4px; }.rw-region-report .story-card{
        display: grid;
...
export const TEMPLATE = `<a class="report-banner" href="https://pages.rewiring.nz/electric-homes-and-vehicles" target="_blank" rel="noopener noreferrer">
    ...
    <div class="section theme-green">
      <div class="container">
        ...
        <div id="ev-tabs"></div>
        <div class="prose">Regarding upfront costs, these are average estimates based on popular recent new car sales in New Zealand. Reliable secondhand EVs typically range from $12,000 to $50,000. There are many different models available at your usual car dealers that meet a wide range of needs. Entry-level options starting as low as $3,000 also exist; with these, as long as you're prepared for limited range, they can offer a low-cost way to get around town.</div>
