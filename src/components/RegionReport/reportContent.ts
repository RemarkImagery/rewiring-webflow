...
export const CSS = `.rw-region-report{
      ...
      @media (max-width: 640px) {.rw-region-report .chart-inner{ min-width: 0; height: 360px; }.rw-region-report .horiz-chart-inner{ min-width: 0; }.rw-region-report .chart-wrap{ padding: 16px 12px; }.rw-region-report .tabs-card{ padding: 16px 10px; }.rw-region-report .cumulative-block{ margin-left: -12px; margin-right: -12px; max-width: none; }.rw-region-report .story-card{ grid-template-columns: 1fr; gap: 18px; }.rw-region-report .story-photo, .rw-region-report .story-photo-ph{ min-height: 240px; }.rw-region-report .story-body{ padding: 0; }
      ...
      @media (max-width: 460px) {.rw-region-report .headline-stats{ grid-template-columns: 1fr; } }.rw-region-report .hero-inner--solo{ grid-template-columns: 1fr; justify-items: start; }.rw-region-report .hero-inner--solo .hero-text{ text-align: left; }.rw-region-report .hero-sub{ font-size: 1.15rem; opacity: 0.9; margin-top: 14px; max-width: 780px; line-height: 1.5; }.rw-region-report .jump-group-title{ text-align: center; font-size: 14px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; color: var(--mid); margin: 30px 0 14px; }.rw-region-report .jumpnav--benefit, .rw-region-report .jumpnav--machine{ grid-template-columns: repeat(5, 1fr); max-width: 1000px; margin: 0 auto; }.rw-region-report .section--overview{ padding-bottom: 36px; }
