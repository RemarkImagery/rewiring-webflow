...
export const CSS = `.rw-region-report{
      ...
      @media (max-width: 780px) {.rw-region-report .savings-stat{ padding: 22px 24px; }.rw-region-report .savings-stat .stat-num{ font-size: clamp(30px, 9vw, 40px); } }.rw-region-report /* Bills intro: headline stats left, .rw-region-report prose right (Jay 2026-07-30) */
      .bills-intro{ display: grid; grid-template-columns: 264px 1fr; gap: 32px; align-items: center; max-width: 960px; margin: 0 auto 40px; }.rw-region-report .bills-intro-stats{ display: flex; flex-direction: column; gap: 16px; }.rw-region-report .bills-intro .prose p{ margin: 0 0 14px; }.rw-region-report .bills-intro .prose p:last-child{ margin-bottom: 0; }
      ...
      @media (max-width: 460px) {.rw-region-report .bills-intro-stats{ flex-direction: column; } }.rw-region-report /* Chart card — clean */
      .chart-wrap{
        background: #ffffff;
        border-radius: 16px;
        padding: 32px;
      ...
      }.rw-region-report .story-body{ padding: 8px 8px 8px 0; }.rw-region-report /* no photo available: hide the reserved photo column and flex-centre the content */
      .story-card.no-photo{ grid-template-columns: 1fr; }.rw-region-report .story-card.no-photo .story-photo{ display: none; }.rw-region-report .story-card.no-photo .story-body{
      ...
      }.rw-region-report /* Phone: charts adapt to fit instead of sideways-scrolling (Jay/OJ mobile feedback 2026-07-30) */
      @media (max-width: 640px){
        .chart-inner { min-width: 0; height: 360px; }
        .horiz-chart-inner { min-width: 0; }
        .chart-wrap { padding: 16px 12px; }
        .tabs-card { padding: 16px 10px; }
        .cumulative-block { margin-left: -12px; margin-right: -12px; max-width: none; }
        .story-card { grid-template-columns: 1fr; gap: 18px; }
        .story-photo, .story-photo-ph { min-height: 240px; }
      ...
      @media (max-width: 860px) {.rw-region-report .headline-stats{ grid-template-columns: repeat(2, 1fr); }.rw-region-report /* mobile: match the machine-section stat boxes so these don't look smaller */
        .hl-num{ font-size: clamp(34px, 9vw, 44px); }.rw-region-report .hl-label{ font-size: 15px; }
      }
      @media (max-width: 460px) {.rw-region-report .headline-stats{ grid-template-columns: 1fr; } }.rw-region-report /* Solo hero — left aligned, .rw-region-report wide subtitle */
      .hero-inner--solo{ grid-template-columns: 1fr; justify-items: start; }.rw-region-report .hero-inner--solo .hero-text{ text-align: left; }.rw-region-report .hero-sub{ font-size: 1.15rem; opacity: 0.9; margin-top: 14px; max-width: 780px; line-height: 1.5; }.rw-region-report /* Jump groups */
