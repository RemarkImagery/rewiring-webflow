...
export default declareComponent(RwReportMachines, {
  ...
  props: {
    ...
    heatPumpPara2: props.Text({ name: "Paragraph 2 · Switching from heatpump switch from…", defaultValue: "Switching from {{heatpump_switch_from}} to a heat pump <strong>saves {{heatpump_15yr_savings}} on bills over 15 years</strong> (around {{heatpump_annual_savings}} every year) and {{heatpump_lifetime_savings}} over the lifetime including upfront costs. {{heater_breakdown}}", group: "Heat pump" }),
    heatPumpPara3: props.Text({ name: "Paragraph 3 · Whatever the fuel type, going…", defaultValue: "Whatever the fuel type, going electric brings significant savings, and the comfort upgrade is immediate.", group: "Heat pump" }),
