...
export default declareComponent(RwReportMachines, {
  ...
  props: {
    ...
    solarAndBatteriesPara3: props.Text({ name: "Paragraph 3 · Solar panels are expected to last…", defaultValue: "Solar panels are expected to <strong>last {{solar_panel_life}} years</strong>, with warranties of a similar length, meaning the system well outlasts any loan used to finance it. Plus a battery locks in lower energy costs into the future and increases household resilience, <strong>keeping essential appliances running during outages</strong>.", group: "Solar and batteries" }),
    electricVehicleHeading: props.Text({ name: "Heading · Electric vehicle", defaultValue: "Electric vehicle", group: "Electric vehicle" }),
    electricVehiclePara1: props.Text({ name: "Paragraph 1 · Households in location currently…", defaultValue: "Households in {{location}} currently spend <strong>{{pump_spend_daily}} at the pump every day</strong>. Yet EVs are <strong>far cheaper to run</strong>, require little maintenance and aren't exposed to volatile global fuel prices. Plus they're quiet, comfortable and fun to drive!", group: "Electric vehicle" }),
    electricVehiclePara2: props.Text({ name: "Paragraph 2 · location drivers cover an average of…", defaultValue: "{{location}} drivers cover an average of <strong>{{driving_weekly_km}} per week</strong>: well within the range of a modern EV. Switching from a petrol to an electric medium SUV <strong>saves around {{ev_annual_savings}} every year</strong>, including road user charges. Diesel ute drivers save even more at <strong>{{ev_ute_savings}} net over 15 years</strong>, or {{ev_ute_annual_savings}} every year. Those who need to drive more will save more from switching to electric.", group: "Electric vehicle" }),
    electricVehiclePara3: props.Text({ name: "Paragraph 3 · And charging is easy. 80% of EV…", defaultValue: "And charging is easy. 80% of EV owners do more than half their charging at home<sup>1</sup>. 60% trickle charge using a standard three-pin plug<sup>2</sup>. Charging at home using grid electricity costs <strong>effectively half what you'd spend on petrol or diesel</strong>, and for those with rooftop solar, the savings are even greater. For when you do need to charge on the go, public chargers are available at least every 75km on 97% of New Zealand highways<sup>3</sup>.", group: "Electric vehicle" }),
    electricVehiclePara4: props.Text({ name: "Paragraph 4 · EVs also eliminate tailpipe…", defaultValue: "EVs also eliminate tailpipe emissions. Vehicle air pollution costs New Zealand an estimated <strong>$10.5 billion every year</strong> in health and productivity costs, plus 2,200+ premature deaths and 9,000+ hospitalisations every year<sup>4</sup>.", group: "Electric vehicle" }),
    heatPumpHeading: props.Text({ name: "Heading · Heat pump", defaultValue: "Heat pump", group: "Heat pump" }),
    heatPumpPara1: props.Text({ name: "Paragraph 1 · Heat pumps use around 75% less energy…", defaultValue: "Heat pumps use around <strong>75% less energy</strong> than gas heaters to deliver the same warmth, and, unlike gas, they cool in summer too. Heat pumps also tend to have lower upfront costs compared to their fossil fuel equivalents.", group: "Heat pump" }),
    heatPumpPara2: props.Text({ name: "Paragraph 2 · heater breakdownSwitching from…", defaultValue: "{{heater_breakdown}}Switching from {{heatpump_switch_from}} to a heat pump <strong>saves {{heatpump_15yr_bill_savings}} on bills over 15 years</strong>, or {{heatpump_15yr_net_savings}} including upfront costs.{{heater_secondary_savings}}{{heater_going_electric_one_fuel_type}}", group: "Heat pump" }),
    heatPumpPara3: props.Text({ name: "Paragraph 3 · heater going electric multiple fuel…", defaultValue: "{{heater_going_electric_multiple_fuel_types}}", group: "Heat pump" }),
    ...
    hotWaterHeatPumpPara1: props.Text({ name: "Paragraph 1 · Hot water heat pumps have a higher…", defaultValue: "Hot water heat pumps have a higher upfront cost, but <strong>deliver the lowest ongoing energy bills</strong> of any water heating option. In {{location}}, switching from {{water_switch_from}} to a hot water heat pump <strong>saves {{water_15yr_bill_savings}} on bills over 15 years</strong>, or {{water_15yr_net_savings}} including upfront costs. {{water_secondary_savings}}", group: "Hot water heat pump" }),
    hotWaterHeatPumpPara2: props.Text({ name: "Paragraph 2 · water breakdown", defaultValue: "{{water_breakdown}}", group: "Hot water heat pump" }),
    hotWaterHeatPumpPara3: props.Text({ name: "Paragraph 3 · Water heating makes up around water…", defaultValue: "Water heating makes up around <strong>{{water_energy_pct}} of an average home's energy load</strong>, making it one of the highest-impact switches a household can make. Hot water heat pumps can also act as a 'thermal battery' where you time it to heat water when electricity is cheapest, or when your solar panels are generating.", group: "Hot water heat pump" }),
    inductionCooktopHeading: props.Text({ name: "Heading · Induction cooktop", defaultValue: "Induction cooktop", group: "Induction cooktop" }),
    inductionCooktopPara1: props.Text({ name: "Paragraph 1 · Cooking doesn't use a lot of energy…", defaultValue: "Cooking doesn't use a lot of energy but electric cooking is <strong>lower cost (and much lower emissions)</strong> than cooking with gas. Induction is more expensive upfront than resistive electric cooking, but offers lower ongoing bills. {{cooktop_breakdown}}Switching from {{cooktop_switch_from}} to induction saves around {{cooktop_15yr_bill_savings}} on energy bills over 15 years. {{cooktop_secondary_savings}}", group: "Induction cooktop" }),
    inductionCooktopPara2: props.Text({ name: "Paragraph 2 · But the most compelling case for…", defaultValue: "But the most compelling case for electric might be <strong>health</strong>. Gas cooking releases nitrogen dioxide and other pollutants into the home, linked nationally to <strong>200+ premature deaths, 3,200+ child asthma cases, and $3.3 billion</strong> in health and productivity costs every year<sup>4</sup>. That's $9,100 per stovetop in New Zealand<sup>5</sup>.", group: "Induction cooktop" }),
