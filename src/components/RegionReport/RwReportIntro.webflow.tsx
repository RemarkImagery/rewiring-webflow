...
export default declareComponent(RwReportIntro, {
  ...
  props: {
    ...
    economicsPara1: props.Text({ name: "Paragraph 1 · Electrifying home appliances and…", defaultValue: "Electrifying home appliances and vehicles, with 80% adopting rooftop solar and batteries, would cut {{location}} household energy costs by <strong>{{elec_savings_annual}} every year</strong>. That's <strong>{{elec_savings_daily}} saved every day</strong>, and meaningful cost of living relief for {{location}} households.", group: "Economics" }),
