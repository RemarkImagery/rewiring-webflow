...
export default declareComponent(RwReportIntro, {
  ...
  props: {
    ...
    heroAndOpportunityPara4: props.Text({ name: "Paragraph 4 · *Community savings assume upgrading…", defaultValue: "*Community savings assume upgrading home appliances to electric and adding solar and batteries to 80% of homes. Net savings include upfront costs and interest.", group: "Hero and opportunity" }),
    ...
    heroAndOpportunityPara6: props.Text({ name: "Paragraph 6 · As more homes electrify, the savings…", defaultValue: "As more homes electrify, the savings add up. By 2040, {{location}} households could collectively save <strong>{{cumulative_bills}} on energy bills</strong>, or <strong>{{cumulative_savings}} net</strong> including upfront costs. And the earlier homes make the switch, the more savings they'll see.", group: "Hero and opportunity" }),
    economicsHeading: props.Text({ name: "Heading · Economics", defaultValue: "Economics", group: "Economics" }),
    economicsPara1: props.Text({ name: "Paragraph 1 · Electrifying home appliances and…", defaultValue: "Electrifying home appliances and vehicles, with 80% adopting rooftop solar and batteries, would cut total household energy-related bills <strong>from {{bills_annual_2040_no_elec}} to {{bills_annual_2040_electrified}} every year</strong>. That's <strong>{{elec_savings_daily}} saved every day</strong>, and meaningful cost of living relief for {{location}} households.", group: "Economics" }),
    economicsPara2: props.Text({ name: "Paragraph 2 · That's fossil spend daily every day…", defaultValue: "That's <strong>{{fossil_spend_daily}} every day</strong> on fossil fuels by just households in {{location}}. Most of these fossil fuels are imported, meaning this money leaves the local economy. Plus, history shows fossil fuel costs are volatile, with <strong>prices rising faster than the rate of inflation</strong>.", group: "Economics" }),
    ...
    emissionsAndJobsPara2: props.Text({ name: "Paragraph 2 · New local jobs, driven by additional…", defaultValue: "<strong>New local jobs</strong>, driven by additional installation labour and the savings flowing through the community.{{jobs_per_resident_line}}", group: "Emissions and jobs" }),
