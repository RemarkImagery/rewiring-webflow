...
export default function NzmeAuction(props: NzmeAuctionProps) {
  const {
    ...
    item3Title = "A Lightfoot scooter",
    item3Desc = "Take home a Lightfoot - the New Zealand-designed electric scooter that charges itself from the sun. New Zealand-made energy on two wheels.",
    item3Image,
    item3StartBid = "500",
