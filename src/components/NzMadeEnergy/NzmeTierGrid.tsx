...
export default function NzmeTierGrid(props: NzmeTierGridProps) {
  const {
    ...
    tier1Text = "We buy Mike a Kiwi suit, laserify it, and he rides the length of the South Island - 944 km of electric hotspots, entrepreneurs and community groups, arriving at the Beehive with a Hiko Hikoi of EVs and e-bikes. Plus billboards across Wellington.",
    tier1Image,
    tier2Amount = "50000",
    tier2Title = "National billboards + solar for homes",
    ...
    tier3Image,
    tier4Amount = "250000",
    tier4Title = "A massive Laser Kiwi",
    tier4Text = "The full ad campaign, $50,000 of solar for low-income homes, and a massive Laser Kiwi - solar panels on its back, green laser eyes - built and towed to Wellington.",
    tier4Image,
    darkColor = "#1a3c3c",
    neonColor = "#4bf03c",
  } = props;
  ...
  const tiers = [
    { amount: parseAmount(tier1Amount, 25000), title: tier1Title, text: tier1Text, img: resolveImage(tier1Image) },
